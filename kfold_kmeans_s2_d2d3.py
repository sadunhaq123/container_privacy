...
for test_element in range (1, 5):
    ...
    # np_test_data_y = test_data_y[test_data_y.columns[0]].to_numpy()
    # print(test_data_y[596:606])
    # print(list_test_data_y[596:606])
    # print(np_test_data_y[596:606])
    # counter_test = collections.Counter(np_test_data_y)
    # print(counter_test)
    #
    # exit()
    ...
    rfc = KMeans(n_clusters=35, verbose=True)
    ...
    dist = [np.linalg.norm(x-y) for x,y in zip(scaled_test_data_x, y_pred_centres[y_pred])]
    #exit()
    #print(dist)
    ...
    accuracy = metrics.accuracy_score(test_data_y, list_of_predictors)
    print(accuracy)
    print(confusion_matrix(test_data_y, list_of_predictors))
    print(classification_report(test_data_y, list_of_predictors))
    print(accuracy_score(test_data_y, list_of_predictors))

    precision = precision_score(test_data_y, list_of_predictors, average='macro')
    print('Precision: %.3f', precision)
    recall = recall_score(test_data_y, list_of_predictors, average='macro')
    print('Recall: %.3f', recall)
    score = f1_score(test_data_y, list_of_predictors, average='macro')
